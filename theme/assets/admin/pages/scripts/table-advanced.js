...
var TableAdvanced = function () {
    ...
    var table = $('#sample_1').DataTable({
            ...
            "tableTools": {
                "sSwfPath": "theme/assets/global/plugins/datatables/extensions/TableTools/swf/copy_csv_xls_pdf.swf", //john
                "aButtons": [{
                    "sExtends": "pdf",
                    "sButtonText": "PDF"
                }, {
        ...
        "footerCallback": function ( row, data, start, end, display ) {
			...
			for (i=2;i<=8;i++)
			{
				...
				// DO NOT CHANGE THE FOOTER VARIABLE. THIS WILL CONFLICT WITH THE SEARCH BUTTON.
				// UPDATE THE DIV SPECIALY DESIGNED FOR THIS.
				// Update footer
				/*
