...
foreach($MultiDimArray as $result){
    ...
    $ypoloipo = $result['YPOLOIPOFORSUM'];
    $clientno +=1;
    $afm = $result['LEEAFM'];
    $leename = $result['LEENAME'];
        ...
        echo $template->render(array('username' => $username,
                                      'clientno'=>$clientno,
                                      'res'=>$MultiDimArray,
                                      'xreosi'=>number_format_clean($xreosi),
                                      'pistosi'=>number_format_clean($pistosi),
                                      'tziros' =>number_format_clean($tziros),
                                      'ypoloipo'=>number_format_clean($ypoloipo),
                                      'LEENAME'=>$leename,
                                      'graph'=>$graph,
                                      'from'=>$from,
                                      'to' => $to,
